...
class TestSupabaseFileService:
    ...
    def mock_supabase_client(self, mocker: "MockerFixture") -> Mock:
        ...
        mocker.patch("app.services.supabase_file_service.create_client", return_value=mock_client)
        return mock_client
    ...
    def test_init_success(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    def test_ensure_bucket_exists_bucket_exists(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    def test_ensure_bucket_exists_creates_bucket(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
        ...
        mock_supabase_client.storage.get_bucket.side_effect = Exception("Bucket not found")
    ...
    def test_ensure_bucket_exists_create_fails(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
        """Test _ensure_bucket_exists raises HTTPException when bucket creation fails."""
        # Make both operations fail
        mock_supabase_client.storage.get_bucket.side_effect = Exception("Bucket not found")
        mock_supabase_client.storage.create_bucket.side_effect = Exception("Create failed")
    ...
    @pytest.mark.asyncio
    async def test_validate_file_metadata_valid_pdf(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_file_metadata_valid_docx(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_file_metadata_case_insensitive(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_file_metadata_invalid_extension(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_validate_file_metadata_no_extension(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_success(self, mock_settings: Mock, mock_supabase_client: Mock, mock_upload_file: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_no_content_type(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
        ...
        assert call_args[1]["file_options"]["content-type"] == "application/octet-stream"

    @pytest.mark.asyncio
    async def test_upload_file_invalid_type(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_upload_fails(self, mock_settings: Mock, mock_supabase_client: Mock, mock_upload_file: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_read_fails(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_generates_correct_path(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
    ...
    @pytest.mark.asyncio
    async def test_upload_file_different_extensions(self, mock_settings: Mock, mock_supabase_client: Mock) -> None:
